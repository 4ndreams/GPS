...
import { getProductos, getProductosEnchapados, getProductosTerciados, type Producto } from '../../services/productoService'; 
...
export default function CrearMinuta() {
  ...
  useEffect(() => {
    const cargarProductos = async () => {
      ...
      try {
        ...
        Alert.alert('Error', 'No se pudieron cargar los productos del backend');
      } finally {
  ...
  // Catálogo de puertas predefinidas (fallback si no hay backend)
